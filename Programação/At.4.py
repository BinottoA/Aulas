...
botao_menos=tk.Button(janela, text="X",command=lambda:inserir_texto("1/"),width=13, height=4,font=("Arial",12))
botao_menos.grid(column=4,row=3)
botao_mult=tk.Button(janela, text="P",command=lambda:inserir_texto("**"),width=13, height=4,font=("Arial",12))
botao_mult.grid(column=4,row=4)
botao_div=tk.Button(janela, text="R",command=lambda:raiz(),width=13, height=4,font=("Arial",12))
